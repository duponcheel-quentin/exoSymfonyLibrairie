 ...
 */
final class Version20190212154045 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE livres (id INT AUTO_INCREMENT NOT NULL, categories_id INT DEFAULT NULL, library_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, author VARCHAR(255) NOT NULL, resume LONGTEXT NOT NULL, edition VARCHAR(255) NOT NULL, date DATE NOT NULL, date_borrowing DATE DEFAULT NULL, date_return DATE DEFAULT NULL, status TINYINT(1) NOT NULL, INDEX IDX_927187A4A21214B7 (categories_id), INDEX IDX_927187A4FE2541D7 (library_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE categories (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, city_id INT DEFAULT NULL, user_name VARCHAR(255) NOT NULL, user_key INT NOT NULL, librarian VARCHAR(255) NOT NULL, INDEX IDX_8D93D6498BAC62AF (city_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
